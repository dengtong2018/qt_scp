#############################################################################
# Makefile for building: scp
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  scp.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile scp.pro
#############################################################################
...
Makefile: scp.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile scp.pro
...
dist: 
	@test -d .tmp/scp1.0.0 || mkdir -p .tmp/scp1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/scp1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/scp1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/scp1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/scp1.0.0/ && (cd `dirname .tmp/scp1.0.0` && $(TAR) scp1.0.0.tar scp1.0.0 && $(COMPRESS) scp1.0.0.tar) && $(MOVE) `dirname .tmp/scp1.0.0`/scp1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/scp1.0.0
